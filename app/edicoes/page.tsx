            ...
            {[
              ...
              >
                <div className="bg-white p-4 rounded-lg shadow-md">
                  <div
                    className={`absolute top-5 ${index % 2 === 0 ? "left-0 md:left-auto md:right-0" : "left-0"} w-10 h-10 rounded-full bg-blue-600 border-4 border-white shadow flex items-center justify-center text-white font-bold z-10`}
                  >
                    {index + 1}
                  </div>
